...
<dl>	
	...
	<dd>		
		...
		<textarea id="inputFileId" rows="20" cols="100%" name="inputFile">Insert here your macro file, or upload a file</textarea>
	</dd>
	...
	<dd>
		...
		<textarea id="jobIdentifierId" rows="1" cols="60%" name="JobIdentifier">MPI Job execution of: <%= date %></textarea>
	</dd>	
...
function addDemo() {
	...
	jobIdentifier.value="MPI Job execution DEMO: "+currentTime.getDate()+"/"+currentTime.getMonth()+"/"+currentTime.getFullYear()+" - "+currentTime.getHours()+":"+currentTime.getMinutes()+":"+currentTime.getSeconds();
